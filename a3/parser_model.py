...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden = nn.Linear(self.embed_size * n_features, self.hidden_size, True)
    ...
    def embedding_lookup(self, t):
        ...
        batch_size, _ = t.size()
        embedding_all = self.pretrained_embeddings(t)
        x = embedding_all.view((batch_size, -1))
        ### END YOUR CODE
        return x
    ...
    def forward(self, t):
        ...
        hidden = F.relu(self.embed_to_hidden(embedding))
        dropout_hidden = self.dropout(hidden)
        logits = self.hidden_to_logits(dropout_hidden)
        ### END YOUR CODE
        return logits
